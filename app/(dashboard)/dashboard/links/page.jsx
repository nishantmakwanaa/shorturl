      ...
      <div className="grid gap-4 px-4 py-4 border-border border rounded-lg">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            list of yout lifetime shortened links.
          </p>
        </div>
        <div>
              ...
              <div>
                {allLinks.map((link) => (
                  <div key={link._id} className="grid gap-2 p-4 linkList">
                    <Link
                      target="_blank"
                      className="text-sm opacity-85 hover:underline flex items-center justify-between"
                    ...
                    <div className="flex gap-2 items-center">
                      <p className="text-sm text-muted-foreground flex items-center gap-1 bg-accent/50 rounded-full px-2 cursor-pointer py-1 w-fit">
                        <CountUp
                      ...
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent className="mt-4">
                          ...
                          <DropdownMenuItem asChild>
                            <AlertDialog>
                              <AlertDialogTrigger asChild>
                                <div className="relative flex cursor-pointer select-none items-center justify-between rounded-sm px-2 py-1.5 text-sm outline-none transition-colors hover:bg-accent hover:text-accent-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50 text-red-400 hover:text-red-400">
                              ...
                              <AlertDialogContent>
                                <AlertDialogHeader>
                                  ...
                                  <AlertDialogDescription>
                                    ...
                                    <Input
                                      className="mt-2"
                                      defaultValue={`https://${location.host}/${link.alias}`}
                                      readOnly
                                    />
                                  </AlertDialogDescription>
                                </AlertDialogHeader>
