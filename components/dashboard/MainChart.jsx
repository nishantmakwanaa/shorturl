  ...
  return (
    <Card className="flex flex-col">
      <CardHeader className="items-center pb-0">
        ...
        <CardDescription className="!-mt-[1px]">to view more visit <Link href="/dashboard/statistics" className="text-emerald-500">Statistics</Link></CardDescription>
      </CardHeader>
      ...
      <CardFooter className="flex-col gap-2 text-sm">
        <div className="flex items-center gap-2 font-medium leading-none">
          Looks like you are {chartData[0].visitors == 0 && <span className="underline underline-offset-[4px] decoration-emerald-500">not</span>} growing<TrendingUp className="h-4 w-4" />
        </div>
