    ...
    return (
        <section className="px-6 md:px-20 lg:px-32 mb-16 max-w-5xl sm:mx-auto">
            <div className="sm:text-center mb-7 grid gap-2 max-w-xs md:max-w-lg sm:mx-auto lg:max-w-xl">
                <h2 className="text-3xl font-semibold lg:text-5xl sm:text-center">What our <span className="underline underline-offset-[5px] decoration-emerald-500">users</span> are <span className="underline underline-offset-[5px] decoration-emerald-500">saying</span>?</h2>
                ...
                <CarouselContent>
                    ...
                    <CarouselItem className="max-w-sm">
                        <div className="bg-card shadow-xs py-4 px-4 rounded-lg border border-border">
                            <div className="flex items-center gap-3">
                                <Avatar className="h-8 w-8">
                                    <AvatarImage src="https://github.com/nishantmakwanaa.png" />
                                    <AvatarFallback>NM</AvatarFallback>
                                </Avatar>
                                <div className="grid !gap-0">
                                    <h2 className="text-lg font-normal">Nishant Makwana</h2>
                                    <span className="-mt-1 text-sm text-muted-foreground">@nishantmakwanaa</span>
                                </div>
                            </div>
